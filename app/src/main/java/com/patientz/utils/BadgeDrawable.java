...
/**
 * Created by windows.7 on 12/27/2016.
 */
...
public class BadgeDrawable extends Drawable {
    ...
    public BadgeDrawable(Context context) {
        ...
        float mTextSize = context.getResources().getDimension(R.dimen.notif_count);
        ...
        mBadgePaint1.setColor(ContextCompat.getColor(context.getApplicationContext(), R.color.colorRedLight));
