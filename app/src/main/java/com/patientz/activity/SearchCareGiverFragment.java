 ...
 */
public class SearchCareGiverFragment extends ListFragment {

    private static final String TAG = "SearchCareGiverFragment";
    Button searchContact;
    private String searchTerm, invitationStatus, searchBy;
    private static String contactRole = "Care Giver";
    ...
    public SearchCareGiverFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //mSearchView = v.findViewById(R.id.search_contact_sub_layout);
        ...
        searchContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                upshotData.put(Constant.UpshotEvents.CT_CG_SEARCH_CLICKED,true);
                UpshotEvents.createCustomEvent(upshotData, Constant.UpshotEventsId.CT_CG_SEARCH_CLICKED);
            ...
            public void onItemSelected(AdapterView<?> arg0, View arg1,
                ...
                if (searchBySpinner.getSelectedItem().toString()
                    ...
                    editTextSearchTerm.setHint(getString(R.string.searchBy)
                            ...
                            /*+ "(" + getString(R.string.add_patient_phoneno)
                            + ")");*/
                    ...
                    // flagToCheckSearchByPhone=false;
                    editTextSearchTerm.setText("");
                    editTextSearchTerm.setInputType(0);
                    editTextSearchTerm
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        // editTextSearchTerm.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
