...
public class AdapterSpecialitiesFacilitiesList extends RecyclerView
        .Adapter<AdapterSpecialitiesFacilitiesList
        .DataObjectHolder> {
    private static String TAG = "AdapterSpecialitiesFacilitiesList";
    private List<Speciality> mDataset;
    ...
    public AdapterSpecialitiesFacilitiesList(OrgBranchesActivity applicationContext, List<OrgBranchVO> myDataset, CountDownTimer countDownTimer) {
        //mDataset = myDataset;
