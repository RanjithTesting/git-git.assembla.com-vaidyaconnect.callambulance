...
/**
 * Created by sunil on 7/6/17.
 */

public class NearbyAEDsAdapter extends RecyclerView.Adapter<NearbyDoctorsListAdapter.ViewHolder> {
    private static final String TAG = "NearbyAEDsAdapter";
    ...
    public NearbyAEDsAdapter(Context activity, ArrayList<DoctorSearchVO> doctorSearchVos) {
        this.doctorsList = doctorSearchVos;
        this.activity = activity;
    }

    @Override
    public NearbyDoctorsListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View inflatedView = LayoutInflater.from(parent.getContext()).inflate(R.layout.nearby_aeds_adapter_layout, parent, false);
        NearbyDoctorsListAdapter.ViewHolder dataObjectHolder = new NearbyDoctorsListAdapter.ViewHolder(inflatedView);
        return dataObjectHolder;
    }

    @Override
    public void onBindViewHolder(final NearbyDoctorsListAdapter.ViewHolder holder, final int position) {
