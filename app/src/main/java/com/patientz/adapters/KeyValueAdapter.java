...
public class KeyValueAdapter extends BaseAdapter {
    ...
    UserInfoVO mInfoVO;
    String flag;
    ArrayList<InsuranceVO> mInsuranceVOs;

    public KeyValueAdapter(Context context, List<KeyValueObject> contactList,
                           String flag, ArrayList<InsuranceVO> insuranceVOs, UserInfoVO userInfoVO) {
        this.mInsuranceVOs = insuranceVOs;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == getCount() - 1
            ...
            if (mInsuranceVOs.get(0).getClaimPhoneNumber() != null) {
                PhoneNumber phoneNumber = new PhoneNumber();
                phoneNumber.setNumberType(context
                        .getString(R.string.phoneNumber));
                phoneNumber.setNumber(mInsuranceVOs.get(0)
                        .getClaimPhoneNumber());
