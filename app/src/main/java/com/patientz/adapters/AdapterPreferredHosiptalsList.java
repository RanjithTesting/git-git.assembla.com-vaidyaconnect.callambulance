...
public class AdapterPreferredHosiptalsList extends RecyclerView
        .Adapter<AdapterPreferredHosiptalsList
        .DataObjectHolder> {
    ...
    public AdapterPreferredHosiptalsList(OrgBranchesActivity applicationContext, List<OrgBranchVO> myDataset, CountDownTimer countDownTimer) {
    ...
    private void setTimeToReach(OrgBranchVO hospitalVO, TextView tvTimeToReach) {
        ...
        Double currentLocationLat = Double.valueOf(mSharedPreferences.getString("lat", "0"));
        Double currentLocationLon = Double.valueOf(mSharedPreferences.getString("lon", "0"));
        LatLng mLatLng = new LatLng(currentLocationLat, currentLocationLon);
        LatLng mLatLngDest = new LatLng(Double.parseDouble(hospitalVO.getAddress().getLatitude()), Double.parseDouble(hospitalVO.getAddress().getLongitude()));

        HttpGet httpGet = new HttpGet("https://maps.googleapis.com/maps/api/directions/json?origin=" + currentLocationLat + "," + currentLocationLon + "&destination=" + hospitalVO.getAddress().getLatitude() + "," + hospitalVO.getAddress().getLongitude() + "&mode=driving" + "&key=" + applicationContext.getString(R.string.server_api_key));
    ...
    private void setProviderToCall(OrgBranchVO hospitalVO) {
       ...
       /* SharedPreferences mSharedPreferences = applicationContext
        ...
        mEditor.commit();
*/
        Log.e("ambulance_provider_name111->", hospitalVO.getDisplayName());
        Log.e("ambulance_provider_pno111->", "-->" + (TextUtils.isEmpty(hospitalVO.getEmergencyPhoneNumber()) ? hospitalVO.getTelephone() : ""));
        Log.e("getEmergencyPhoneNumber111->", "-->" + hospitalVO.getEmergencyPhoneNumber());
        Log.e("getTelephone111->", "-->" + hospitalVO.getTelephone());
